...
import personajerol.exceptions.AgilidadNoValidaException;
import personajerol.exceptions.FuerzaNoValidaException;
import personajerol.exceptions.VidaNoValidaException;
...
public class Personaje {
	...
	public int hacerAtaque() {
		...
		dañoProducido = (int) (Math.random()*fuerza);
	...
	public void recibirGolpe(int golpe) {
		...
		dañoRecibido = golpe-((int)(Math.random()*agilidad));
